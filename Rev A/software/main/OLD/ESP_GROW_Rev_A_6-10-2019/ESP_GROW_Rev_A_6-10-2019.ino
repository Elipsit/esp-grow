...
const int scrbtn = 12; //push button
...
//Revision
 Serial.println(revision);
  ...
  if(!display.begin(SSD1306_SWITCHCAPVCC, 0x3C)) { // Address 0x3D for 128x64
    ...
    display.display();
       server.on("/", [](){
    page = "<div style=\"color: #484D79;\"><h1>ESP-GROW Web Server</h1></h2>By: Kyle Rodrigues | 03/03/2019</h2><h3>Soil Moisture Content(%):</h3><h4>"+String(soilval)+"</h4><h3>Temperature(oC):</h3> <h4>"+String(t)+"</h4><h3>Humidity(%):</h3><h4>"+String(h)+"</h4>";
