...
//Revision
 Serial.println(F("ESP-GROW_04072019"));
  ...
  if(!display.begin(SSD1306_SWITCHCAPVCC, 0x3C)) { 
    ...
    display.display();
    server.on("/", [](){
    page = "<h1>ESP-GROW Strawberry Banana</h1></h2>By: Kyle Rodrigues | 05/05/2019</h2><h3>Soil Moisture Content(%):</h3> <h4>"+String(soilval)+"</h4><h3>Temperature(oC):</h3> <h4>"+String(t)+"</h4><h3>Humidity(%):</h3> <h4>"+String(h)+"</h4>";
