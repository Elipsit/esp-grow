...
//Revision
 Serial.println(F("ESP-GROW_04072019"));
  ...
  if(!display.begin(SSD1306_SWITCHCAPVCC, 0x3C)) { // Address 0x3D for 128x64
    ...
    display.display();
    server.on("/", [](){
    page = "<h1>ESP-GROW Strawberry Banana</h1></h2>By: Kyle Rodrigues | 05/05/2019</h2></p>Strawberry Banana is a 70/30 indica-dominant cannabis strain developed by DNA Genetics in collaboration with Serious Seeds. A genetic cross between Crockett’s Banana Kush and the “Strawberry” phenotype of Bubble Gum, Strawberry Banana inherits a sweet fruity flavor that earned this hybrid her name. Known for its heavy resin production and high THC content, Strawberry Banana produces happy, peaceful effects that sharpen creativity and sensory awareness.</p><h3>Soil Moisture Content(%):</h3> <h4>"+String(soilval)+"</h4><h3>Temperature(oC):</h3> <h4>"+String(t)+"</h4><h3>Humidity(%):</h3> <h4>"+String(h)+"</h4>";
